...
const Yuklangan = () => {
  const [prag,setPrag]=useState(JSON.parse(window.localStorage.getItem("OqtuvchiApp"))|| false);
  const [arxivOqtuvchi,setarxivOqtuvchi]=useState(JSON.parse(window.localStorage.getItem("arxivOqtuvchi"))|| false)
