...
const BoshqaApp = () => {
  ...
  const [soni,setSoni]=useState(JSON.parse(window.localStorage.getItem("BoshqaApp"))|| false)
  const soniHendil=()=>{
    setSoni(soni+1)
    console.log(soni);
    JSON.stringify(localStorage.setItem("BoshqaApp", soni))
  }
  console.log(soni);
  return (
    <div >
